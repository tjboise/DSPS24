...
model = ModifiedFCN(num_classes=1)

# Initialize U-Net model
# model = smp.Unet(
#     encoder_name="resnet18",  # Choose encoder, e.g. resnet18, resnet34, etc.
#     encoder_weights="imagenet",  # Use pre-trained weights from ImageNet
#     in_channels=3,  # Number of input channels
#     classes=1,  # Number of output channels (e.g., 1 for gray-scale segmentation map)
# )
model = model.to(device)
